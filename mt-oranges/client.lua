...
RegisterNetEvent('mt-oranges:client:RetirarVeiculo', function()
...
RegisterNetEvent('mt-oranges:client:GuardarVeiculo', function()
...
Citizen.CreateThread(function()
    exports['qb-target']:AddBoxZone("CarPed", Config.CarPedLoc, 1, 1, {
        ...
        options = {
            {
                type = "client",
                event = "mt-oranges:client:RetirarVeiculo",
                icon = "fas fa-car",
                label = 'Take farm car'
            },
            {
                type = "client",
                event = "mt-oranges:client:GuardarVeiculo",
                icon = "fas fa-car",
                label = 'Put back car'
            },
        },
...
RegisterNetEvent('mt-oranges:client:ApanharLaranjas', function(data)
    ...
    QBCore.Functions.Progressbar('pick-fiel', 'PICKING SOME ORANGES...', 5000, false, true, {
        ...
        ClearPedTasks(ped)
        TriggerServerEvent('mt-oranges:server:ApanharLaranjas')
...
RegisterNetEvent('mt-oranges:client:ProcessarLaranjas', function(data)
    local ped = PlayerPedId()
    ...
    QBCore.Functions.Progressbar('pick-fiel', 'MAKING ORANGE JUICE...', 5000, false, true, {
        ...
        ClearPedTasks(ped)
        TriggerServerEvent('mt-oranges:server:ProcessarLaranjas')
...
Citizen.CreateThread(function()
    exports['qb-target']:AddBoxZone("ProcessPed", Config.ProcessPedLoc, 1, 1, {
        ...
        options = {
            {
                type = "client",
                event = "mt-oranges:client:ProcessarLaranjas",
...
Citizen.CreateThread(function()
    exports['qb-target']:AddBoxZone("SellPed", Config.OrangesSell, 1, 1, {
        ...
        options = {
            {
                type = "client",
                event = "mt-oranges:client:VenderSumo",
                icon = "fas fa-wine-bottle",
...
RegisterNetEvent('mt-oranges:client:VenderSumo', function(data)
    local ped = PlayerPedId()
    ...
    QBCore.Functions.Progressbar('pick-fiel', 'SELLING ORANGE JUICE...', 5000, false, true, {
        ...
        ClearPedTasks(ped)
        TriggerServerEvent('mt-oranges:server:VenderSumo')
        SetNewWaypoint(Config.OrangesSell)
