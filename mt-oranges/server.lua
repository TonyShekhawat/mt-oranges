...
RegisterNetEvent('mt-oranges:server:ApanharLaranjas', function()
    local src = source
...
RegisterNetEvent('mt-oranges:server:ProcessarLaranjas', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('mt-oranges:server:VenderSumo', function()
    local src = source
    local price = 0
    local Player = QBCore.Functions.GetPlayer(src)
